...
@SpringBootTest
class GoogleClientPortTest {
    @Autowired
    GoogleClientPort googleClientPort;
    @Test
    void getUserFromIdToken() {
        ...
        SimpleUserModel simpleUserModel = googleClientPort.getUserFromIdToken(idToken);
